...
const SERVICE_OPTIONS = [
  ...
  { type: 'opalina_imagen_cuarto',   icon: 'ti-sparkles', label: 'Opalina · Imagen 1/4 de hoja',    defaultPrice: 9  },
  { type: 'opalina_imagen_medio',    icon: 'ti-sparkles', label: 'Opalina · Imagen 1/2 hoja carta', defaultPrice: 13 },
  { type: 'opalina_imagen_completa', icon: 'ti-sparkles', label: 'Opalina · Imagen hoja completa',  defaultPrice: 19 },
