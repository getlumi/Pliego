...
export const SERVICE_LABELS = {
  ...
  opalina_imagen_cuarto:   { icon: 'ti-sparkles', label: 'Opalina · Imagen 1/4 de hoja' },
  opalina_imagen_medio:    { icon: 'ti-sparkles', label: 'Opalina · Imagen 1/2 hoja carta' },
  opalina_imagen_completa: { icon: 'ti-sparkles', label: 'Opalina · Imagen hoja completa' },
